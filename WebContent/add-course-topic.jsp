	          ...
	          <div class="container-fluid">
                    ...
                    <div class="card">
                         <div class="ml-3 mt-3 mr-3 mb-5">
                             <h3 class="mb-4">Add Course Topics</h3>
                             
                             
                    	       
                    	       <form action="TopicAdd.jsp" method="">
                    	...
                    	<%
                             	Rdao rd=new Rdao();
                             	ResultSet rs=rd.showTopicId();
                             	while(rs.next()){
                         %>
                    	    	   	      	    <option><%=rs.getInt(1) %></option>   
                 <!-- this data will come from back end at run time from course_info table only course_code -->
                    	  ...
                    	  %>  
                    	    	      ...
                    	    	      <div class="form-group"> 
                    	    	   	      ...
                    	    	   	      <input type="text" required name="topic_name" class="form-control">
                    	    	      </div>
                    	    	      
                                       <input type="submit" value="Add Topic" class="site-btn mt-3">   
                     	       </form>
