...
<body>
	...
	<div id="wrapper">
      ...
      <div id="content-wrapper">
	          <div class="container-fluid">
                    ...
                    <div class="card">
                         <div class="ml-3 mt-3 mr-3 mb-5">
                             <h3 class="mb-4">Available Course</h3>
            ...
            <%
            	Rdao rd=new Rdao();
            	ResultSet rs= rd.adminAvailableCourse();
                while(rs.next()){
                                                  ...
                                                  <td ><%=rs.getInt(1) %></td>
                                                   <td ><%=rs.getInt(2) %></td>
                                                    ...
                                                    <td><%=rs.getString(4) %></td>
                                                     <td ><a href="update-course.jsp?id=<%=rs.getInt(1) %>&course_id=<%=rs.getInt(2) %>&course_name=<%=rs.getString(3) %>&category=<%=rs.getString(4) %>">Update Course</a></td>
                                                     <td ><a href="DeleteAvailableCourse.jsp?id=<%=rs.getInt(1) %>">Delete</a></td>
                                             </tr>
