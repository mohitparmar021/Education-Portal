	...
	<div id="wrapper">
      ...
      <div id="content-wrapper">
	          <div class="container-fluid">
                      	   ...
                      	   <div class="card">
                      	     <h2 style="color: #001f3f" class=" mt-4 text-center"><%=course_name %></h2>
                      	    
                      	     <%
                      	     int id=Integer.parseInt(request.getParameter("id"));
							mylist1=rd.showContent(id, course_id);
							for(TopicContentInfo H1:mylist1)
		   		{
				%>
                      	      <h2 style="color: #001f3f" class="ml-3 mt-4 mb-4"><%=H1.getTopic_name() %></h2>
                      	   	     <p class="ml-3"></p>
  <p style="color:black;" class="ml-3 mr-3"><%=H1.getTopic_content() %> </p>
  <br><br>
 <div class="course-meta-area">
 <br>
  <iframe width="640" style="margin-left: 25%" height="360" src=<%=H1.getSrc() %> frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>	          
  <br>
  </div>
  <%
